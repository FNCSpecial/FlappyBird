...
///ustawianie koloru rur
ALLEGRO_COLOR rura = al_map_rgb(0, 155, 26);
...
int main() {
	...
	bgmenu = al_load_bitmap("bgmenu.png");

	ALLEGRO_BITMAP* przycisk1 = NULL;
	przycisk1 = al_load_bitmap("graj.png");

	ALLEGRO_BITMAP* przycisk2 = NULL;
	przycisk2 = al_load_bitmap("wyjdz.png");
	...
	int gamestate = 1;
	int typ = 0;
	std::string text = "Aby zagrać wciśnij 1 na klawiaturze";
	...
	//rejestracja eventów 
	ALLEGRO_TIMER* timer = timer = al_create_timer(1/FPS);  //ustawia timer na odświeżanie 60 klatek na sekunde 
	...
	// al_register_event_source(event_queue, al_get_display_event_source(display));
		...
		while (!end)
		{
			...
			case 1:
				...
				al_draw_bitmap(przycisk1, 400, 200,0);
			//	al_draw_text(font,green, 230, 350, 0,text);
				al_draw_bitmap(przycisk2, 400, 300,0);
			...
			case 2:
				...
				if (draw) {
					...
					al_draw_filled_rectangle(x1, y1, x1 - 50, r1[j], rura);//glowna rura
					al_draw_rectangle(x1, y1, x1 - 50, r1[j], green, 3);//otoczka
					al_draw_filled_rectangle(x1 - 60, r1[j] - 50, x1 + 10, r1[j] + 5, rura);//dol rury
					al_draw_rectangle(x1 - 60, r1[j] - 50, x1 + 10, r1[j] + 5, green, 3);//otoczka

					r2 = r1[j] + 100;

					al_draw_filled_rectangle(x2, y2, x2 - 50, r2, rura);//rura glowna dolna
					al_draw_rectangle(x2, y2, x2 - 50, r2, green, 3); //otoczka
					al_draw_filled_rectangle(x2 - 60, r2 + 50, x2 + 10, r2 - 5, rura); //gora rury
					al_draw_rectangle(x2 - 60, r2 + 50, x2 + 10, r2 - 5, green, 3); // otoczka
					x1 -= 5;
					x2 -= 5;
